    ...
    <div class="admin-body">
      ...
      <div class="admin-table">
        <el-table style='width:100%' align="center" :data="classList"  v-loading="listLoading" element-loading-text="拼命加载中">
          ...
          <el-table-column prop="updatedAt" min-width="140" label="评论文章" :formatter="row => $filter.timeStampFormat(row.updatedAt, 'yyyy-MM-dd hh:mm')"></el-table-column>
          <el-table-column prop="title" min-width="280" label="昵称" ></el-table-column>
          <el-table-column prop="createdAt" min-width="140" label="邮箱" :formatter="row => $filter.timeStampFormat(row.createdAt, 'yyyy-MM-dd hh:mm')"></el-table-column>
          <el-table-column prop="updatedAt" min-width="140" label="评论内容" :formatter="row => $filter.timeStampFormat(row.updatedAt, 'yyyy-MM-dd hh:mm')"></el-table-column>
          <el-table-column prop="updatedAt" min-width="140" label="评论时间" :formatter="row => $filter.timeStampFormat(row.updatedAt, 'yyyy-MM-dd hh:mm')"></el-table-column>
          <el-table-column min-width="150" label="操作" fixed="right" align="center">
            <template slot-scope='scope'>
              <el-button type='primary' @click="showClassifyDialg({id:scope.row._id, title:scope.row.title})">回复</el-button>
