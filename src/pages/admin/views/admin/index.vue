<template>
  <div class="wrapper">
    ...
    <el-dialog title="修改密码" v-model="modifyDialogVisible">
...
<script>
import { ElIcon, ElDropdown, ElDropdownItem, ElDropdownMenu, ElContainer, ElAside, ElMenu, ElSubmenu, ElMenuItem, ElDialog, ElForm, ElInput, ElMain, ElFormItem, ElButton } from 'element-plus';
